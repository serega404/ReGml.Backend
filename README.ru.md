...
- Обновлена документация по установке и настройке. (портировано в Gml.Backend)
- Сделан кастомный установщик и менеджер версий. (портировано в Gml.Backend)
- Поддержка версий Gml.Backend начиная с 2025.3 и новее. (портировано в Gml.Backend)
- Добавлена поддержка Alpine Linux для установщика. (портировано в Gml.Backend)
